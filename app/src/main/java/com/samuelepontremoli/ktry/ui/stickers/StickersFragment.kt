...
class StickersFragment : Fragment(), IStickersContract.IStickersView {
    ...
    private var stickersAdapter: GifsListAdapter? = null
...
//        mainRecycler.setItemViewCacheSize(20)
        ...
        stickersAdapter = GifsListAdapter(mutableListOf(), GifsListAdapter.TYPE_STICKER)
        mainRecycler.adapter = stickersAdapter
        infiniteScrollListener = InfiniteScrollListener({ presenter?.loadStickers() }, manager)
